          ...
          "
            ...
            "
                ...
                "
                  ...
                  hover:opacity-75
                "
								href="https://refactoring.guru/pt-br/design-patterns/csharp" target="_blank"
							>
								<i class="text-lg leading-lg text-white opacity-75" /><span
									class="ml-2"
...
#app {
	background: linear-gradient(-45deg, #b8a2ed, #131219, #4a5568, #6649a0);
